 ...
 */
function activateCsv(app, restorer, themeManager, mainMenu, searchregistry = null) {
 ...
 */
function activateTsv(app, restorer, themeManager, mainMenu, searchregistry = null) {
...
(function (Private) {
     ...
     */
    Private.LIGHT_STYLE = Object.assign({}, DataGrid.defaultStyle, { voidColor: '#F3F3F3', backgroundColor: 'white', headerBackgroundColor: '#EEEEEE', gridLineColor: 'rgba(20, 20, 20, 0.15)', headerGridLineColor: 'rgba(20, 20, 20, 0.25)', rowBackgroundColor: i => (i % 2 === 0 ? '#F5F5F5' : 'white') });
    /**
