...
export const editorSyntaxStatus = {
    ...
    activate: (app, statusBar, tracker, labShell) => {
...
function activateEditorCommands(app, tracker, settingRegistry, mainMenu) {
    ...
    let { theme, keyMap, scrollPastEnd, styleActiveLine, styleSelectedText, selectionPointer } = CodeMirrorEditor.defaultConfig;
    /**
    ...
    async function updateSettings(settings) {
        ...
        styleActiveLine =
            settings.get('styleActiveLine').composite || styleActiveLine;
        styleSelectedText =
            settings.get('styleSelectedText').composite ||
                styleSelectedText;
        selectionPointer =
            settings.get('selectionPointer').composite ||
                selectionPointer;
    }
    /**
